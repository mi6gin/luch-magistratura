...
<div class="app-shell">
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="nav">
            ...
            <a href="{{ route('model-health') }}" class="nav-link {{ ($page ?? '') === 'model-health' ? 'active' : '' }}"><i>◎</i><span>Здоровье модели</span><em>07</em></a>
        </nav>
